...
this.attrs_ = {};utils.updateDeep(this.attrs_,_dygraphDefaultAttrs2['default']);this.boundaryIds_ = [];this.setIndexByName_ = {};this.datasetIndex_ = [];this.registeredEvents_ = [];this.eventListeners_ = {};this.attributes_ = new _dygraphOptions2['default'](this);this.lastMouseMoveEvent_ = null;this.currentZoomRectArgs_ = null; // Create the containing DIV and other interactive elements
 ...
 *     function. Used to avoid excess redrawing
 * @private
 */Dygraph.prototype.drawZoomRect_ = function(direction,startX,endX,startY,endY,prevDirection,prevEndX,prevEndY){var ctx=this.canvas_ctx_;this.currentZoomRectArgs_ = arguments; // Clean up from the previous rect if necessary
 ...
 * @private
 */Dygraph.prototype.mouseMove_ = function(event){this.lastMouseMoveEvent_ = event; // This prevents JS errors when mousing over the canvas before data loads.
...
this.canvas_.getContext('2d').clearRect(0,0,this.width_,this.height_);var drawCallback=this.getFunctionOption("drawCallback");if(drawCallback !== null){drawCallback.call(this,this,is_initial_draw);}if(is_initial_draw){this.readyFired_ = true;while(this.readyFns_.length > 0) {var fn=this.readyFns_.pop();fn(this);}}if(this.lastMouseMoveEvent_ !== null){this.mouseMove_(this.lastMouseMoveEvent_);}if(this.currentZoomRectArgs_ !== null){this.drawZoomRect_.apply(this,this.currentZoomRectArgs_);}}; /**
 * @private
